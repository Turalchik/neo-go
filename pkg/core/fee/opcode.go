...
var (
	appendW              = []int64{965, 1875, 44314}
	catW                 = []int64{76, 11886}
	clearW               = []int64{928, -211, 30857}
	clearItemsW          = []int64{897, 10072}
	convertArrOrStructW  = []int64{2921, 33000}
	convertByteArrayW    = []int64{52, 155282}
	dropW                = []int64{934, 19393}
	dupW                 = []int64{50, 231714}
	hasKeyW              = []int64{392, 2109, 18063}
	initSlotW            = []int64{4023, 13745}
	keysW                = []int64{13948, 84697}
	memcpyW              = []int64{6, 33312}
	newArrayAnyW         = []int64{1881, 85312}
	newArrayByteOrIntW   = []int64{8953, 38914}
	newBufferW           = []int64{63, 17891}
	packW                = []int64{1659, 75925}
	packMapW             = []int64{1001, 2077, 66535}
	pickItemAnyW         = []int64{718, 2294, 840, 20461}
	pickItemByteArrayW   = []int64{765, 2315, 60, 16216}
	popItemW             = []int64{825, 39018}
	removeW              = []int64{919, 2263, 26938}
	reverseItemsArrayW   = []int64{393, 230, 14021}
	reverseItemsBufferW  = []int64{92, 29431}
	reverseW             = []int64{180, 23110}
	rollW                = []int64{55, 16920}
	setitemW             = []int64{1038, 3587, 4087, 17736}
	sizeW                = []int64{927, 32486}
	stW                  = []int64{825, 48954}
	substrW              = []int64{46, 187501}
	unpackArrayOrStructW = []int64{1179, 7114}
	unpackMapW           = []int64{1026, 111184}
	valuesW              = []int64{3016, 3680, 100441}
	xDropW               = []int64{946, 58, 15029}
)
...
func convertGas(args *vm.OpcodePriceArgs) int64 {
	...
	return convertByteArrayW[0]*int64(args.Length) + convertByteArrayW[1]
}
...
func hasKeyGas(args *vm.OpcodePriceArgs) int64 {
	return hasKeyW[0]*int64(args.RefsDelta) + hasKeyW[1]*int64(args.NComparisons) + hasKeyW[2]
}
...
func packMapGas(args *vm.OpcodePriceArgs) int64 {
	return packMapW[0]*int64(args.RefsDelta) + packMapW[1]*int64(args.NComparisons) + packMapW[2]
}

func pickItemGas(args *vm.OpcodePriceArgs) int64 {
	if args.Typ == stackitem.ByteArrayT {
		return pickItemByteArrayW[0]*int64(args.RefsDelta) + pickItemByteArrayW[1]*int64(args.NComparisons) +
			pickItemByteArrayW[2]*int64(args.Length) + pickItemByteArrayW[3]
	}
	return pickItemAnyW[0]*int64(args.RefsDelta) + pickItemAnyW[1]*int64(args.NComparisons) +
		pickItemAnyW[2]*int64(args.Length) + pickItemAnyW[3]
}
...
func removeGas(args *vm.OpcodePriceArgs) int64 {
	return removeW[0]*int64(args.RefsDelta) + removeW[1]*int64(args.NComparisons) + removeW[2]
}

func reverseItemsGas(args *vm.OpcodePriceArgs) int64 {
	if args.Typ == stackitem.BufferT {
		return reverseItemsBufferW[0]*int64(args.Length) + reverseItemsBufferW[1]
	}
	return reverseItemsArrayW[0]*int64(args.RefsDelta) + reverseItemsArrayW[1]*int64(args.Length) + reverseItemsArrayW[2]
}
...
func setItemGas(args *vm.OpcodePriceArgs) int64 {
	return setitemW[0]*int64(args.RefsDelta) + setitemW[1]*int64(args.NClonedItems) +
		setitemW[2]*int64(args.NComparisons) + setitemW[3]
}
...
func unpackGas(args *vm.OpcodePriceArgs) int64 {
	if args.Typ == stackitem.MapT {
		return unpackMapW[0]*int64(args.Length) + unpackMapW[1]
	}
	return unpackArrayOrStructW[0]*int64(args.Length) + unpackArrayOrStructW[1]
}
