...
func convertGas(params *vm.OpcodePriceParams) int64 {
	switch params.Typ {
	case stackitem.AnyT:
		return convertArrOrStructW[0]*int64(params.RefsDelta) + convertAnyw[1]
...
func initSlotGas(params *vm.OpcodePriceParams) int64 {
	return initSlotW[0]*int64(params.Length) + initSlotW[1]
}
...
func pickItemGas(params *vm.OpcodePriceParams) int64 {
	return pickItemW[0]*int64(params.RefsDelta) + pickItemW[1]*int64(params.Length) + pickItemW[2]
}
...
func removeGas(params *vm.OpcodePriceParams) int64 {
	...
	return removeArrW[0]*int64(params.RefsDelta) + removeArrW[1]*int64(params.Length) + removeArrW[2]
}
